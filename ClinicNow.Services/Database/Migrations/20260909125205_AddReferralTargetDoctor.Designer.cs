...
namespace ClinicNow.Services.Database.Migrations
{
    ...
    [Migration("20260909125205_AddReferralTargetDoctor")]
    partial class AddReferralTargetDoctor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.Appointment", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DoctorId", "StartUtc"), new[] { "EndUtc", "Status" });

                    b.HasIndex("PatientId", "StartUtc");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("PatientId", "StartUtc"), new[] { "EndUtc", "Status" });
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.LabFinding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppointmentId = 1,
                            ContentHash = "BD84E762D65BA7554EFD671A9AEDA45F",
                            ContentType = "application/pdf",
                            CreatedAtUtc = new DateTime(2026, 8, 18, 9, 30, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.MedicalRecordAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MedicalRecordAuditLog");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MedicalRecordId = 1,
                            OccurredAtUtc = new DateTime(2026, 8, 10, 9, 30, 0, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.NewsItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ContentHash = "431CED6916A2A21A156E38701AFE55BB",
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.Payment", b =>
                {
                    ...
                    b.Property<decimal?>("CapturedAmountEur")
                        .HasColumnType("decimal(8,2)");
                    ...
                    b.Property<DateTime?>("RefundFailedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.ScheduleBlock", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DoctorId", "StartUtc"), new[] { "EndUtc" });
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("TokensValidFromUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.WorkingHours", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DoctorId", "DayOfWeek"), new[] { "StartTime", "EndTime" });
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.LabFinding", b =>
                {
                    ...
                    b.HasOne("ClinicNow.Services.Database.Entities.User", "EnteredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicNow.Services.Database.Entities.Referral", b =>
                {
                    ...
                    b.HasOne("ClinicNow.Services.Database.Entities.Doctor", "TargetDoctor")
                        .WithMany()
