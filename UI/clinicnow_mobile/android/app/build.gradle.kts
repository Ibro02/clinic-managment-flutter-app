...
android {
    ...
    compileOptions {
        ...
        // that do not exist below API 26. Desugaring backports them rather than
        // forcing minSdk up and dropping older phones.
...
dependencies {
    // The backport library the desugaring above runs on.
